        ...
        <div class="col-md-6">
            <div>
                <select id="debit-account-no">
                    <option value="null">Choose Diplome</option>
                    <option value="acc-one">Diplome One</option>
                    <option value="acc-two">Diplome Two</option>
                </select>
                <input id="debit-amount" type="text" /> <button id="debit-btn">Decrease Volume</button><br/>
                <select id="credit-account-no">
                    <option value="null">Choose Diplome</option>
                    <option value="acc-one">Diplome One</option>
                    <option  value="acc-two">Diplome Two</option>
                </select>
                <input id="credit-amount" type="text" /> <button id="credit-btn">Increase Volume</button>
            </div>
        </div>
    </div>
<br/><br/>
