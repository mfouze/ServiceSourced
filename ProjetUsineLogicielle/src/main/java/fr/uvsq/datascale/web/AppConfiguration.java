...
public class AppConfiguration {
    ...
    public ClusterSelector clusterSelector() {
        ...
        clusterMap.put("fr.uvsq.datascale.eventhandler", normalCluster());
        clusterMap.put("fr.uvsq.datascale.replay", replayCluster());
     ...
     */
    @Bean
    public Repository<Diplome> eventSourcingRepository() {
        EventSourcingRepository eventSourcingRepository = new EventSourcingRepository(Diplome.class, jdbcEventStore());
